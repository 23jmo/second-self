...
echo "[1/8] Checking user account..."
...
# ─── Step 2: Copy repo ───
echo "[2/8] Copying repo to $SECOND_HOME..."
...
# ─── Step 4: Clear quarantine on Vine Server ───
echo "[4/8] Clearing quarantine on Vine Server..."
...
echo "[5/8] Installing LaunchAgents..."
...
# ─── Step 6: Enable Fast User Switching + initial login ───
echo "[6/8] Checking if secondself has a GUI session..."
...
echo "[7/8] Starting services in secondself's session..."
SECOND_UID=$(id -u "$SECOND_USER")
